...
$sql = "SELECT id_annee, annee FROM annee {$whereSql} ORDER BY {$sort} {$dir}";
if ($perPage !== 'all') {
      ...
      <?php foreach ($items as $it): ?>
        <tr>
          ...
          <td>
            ...
            <a href="edit.php?id=<?= $it['id_annee'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
