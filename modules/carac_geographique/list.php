...
$sql = "SELECT id_geo, description, notes FROM carac_geographique {$whereSql} ORDER BY {$sort} {$dir}";
if ($perPage !== 'all') {
      ...
      <?php foreach ($items as $it): ?>
        <tr>
          ...
          <td>
            ...
            <a href="edit.php?id=<?= $it['id_geo'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
