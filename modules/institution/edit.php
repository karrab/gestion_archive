...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        db()->prepare('UPDATE institution SET description = ?, notes = ? WHERE id_ins = ?')->execute([$description, $notes, $id]);
        log_historique('modification', 'institution', "Modification #{$id}");
...
$pageTitle = 'تعديل المؤسسة';
require __DIR__ . '/../../includes/layout_header.php';
?>
<h4 class="mb-3"><i class="bi bi-pencil"></i> تعديل المؤسسة</h4>
