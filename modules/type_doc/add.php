...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        db()->prepare('INSERT INTO type_doc (description, notes) VALUES (?, ?)')->execute([$description, $notes]);
        log_historique('ajout', 'type_doc', "Ajout: {$description}");
        flash_set('success', 'تمت الإضافة بنجاح.');
        redirect('list.php');
    }
}

$pageTitle = 'إضافة نوع الوثيقة';
require __DIR__ . '/../../includes/layout_header.php';
?>
<h4 class="mb-3"><i class="bi bi-plus-lg"></i> إضافة نوع الوثيقة</h4>
