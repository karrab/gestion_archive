...
('transfert.manage','Gérer les transferts','transfert'),
('versement.manage','Gérer les versements','versement'),
('elimination.manage','Gérer les éliminations','elimination'),
('reference.manage','Gérer les tables de référence','reference'),
('user.manage','Gérer les utilisateurs et permissions','user'),
